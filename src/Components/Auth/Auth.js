...
class Auth extends Component {
  ...
  login = () => {
    ...
    axios.post('/api/login_User', {username, password}).then(res => {
    ...
    render(){
        ...
        return(
            <div>
                ...
                <button className="homeBtn" onClick={this.login}> Login </button>
