...
class Auth extends Component {
  ...
  register = () => {
    const { username, password } = this.state;
    axios
      .post("/api/add_User", { username, password })
      .then((res) => {
        this.props.loginUser(res.data);
        this.props.history.push("/dashboard");
      })
  ...
  render() {
    ...
    return (
      <main className="authPage">
        <section className="contentBoxAuth">
          <div className="authentication">
            ...
            <div className="authButtonContainer">
              <button className="homeBtn" onClick={this.login}>
                {" "}
                Login{" "}
              </button>
              <button className="homeBtn" onClick={this.register}>
                {" "}
                Register{" "}
              </button>
            </div>
